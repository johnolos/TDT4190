...
/**
 * A collection of globally available constants and static methods.
 */
class Globals {
	// The four "constants" below may be changed by data in the input file.

	/**
	 * The number of milliseconds to wait for a lock before a timeout is
	 * declared.
	 */
	static long TIMEOUT_INTERVAL = 200; // Timeouts disabled
	/**
	...
	/**
	 * The maximum interval between the end of a transaction and the arrival of
	 * a new one at a server
	 */
	static final long MAX_ARRIVAL_WAIT = 300;
	/**
	 * The minimum interval between the end of a transaction and the arrival of
	 * a new one at a server
	 */
