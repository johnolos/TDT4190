...
/**
 * This class reads the data in an input file. Blank lines and lines starting
 * with the "#" sign are skipped.
 */
class TransactionFileReader {
	 ...
	 * 
	 * @return The next non-blank, non-comment line, or null if the end of file
	 *         is reached.
	 */
	String readLine() {
		try {
