...
class ResourceAccess {
	...
	final int serverId;
	/**
	 * The ID of the resource. This number is not globally unique, only unique
	 * for a given server.
	 */
	...
	/**
	 * Checks whether or not two ResourceAccess objects represent the same
	 * resource.
	 * 
	 * @param o
	 *            The ResourceAccess to compare this ResourceAccess with.
